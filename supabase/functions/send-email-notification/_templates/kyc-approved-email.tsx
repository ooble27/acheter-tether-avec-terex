import { wrapEmail, hero, infoTable, ctaButton, statusBadge, checkRing, C } from './html-utils.ts';
...
export function kycApprovedHtml({ magicLink, userFirstName, userLastName }: KYCApprovedEmailProps): string {
  ...
  <div style="padding:0 0 24px;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:${C.infoBg};border:1px solid ${C.border};border-radius:10px;overflow:hidden;border-collapse:separate;border-spacing:0;">
      <tr>
        <td style="padding:20px 16px;vertical-align:top;width:33%;border-right:1px solid ${C.border};text-align:center;">
          <p style="font-family:${F};font-size:17px;font-weight:700;color:${C.text};margin:0 0 4px 0;">5M+</p>
          <p style="font-family:${F};font-size:11px;color:${C.textDim};margin:0;line-height:1.5;">CFA / jour<br>de limite</p>
        </td>
        <td style="padding:20px 16px;vertical-align:top;width:33%;border-right:1px solid ${C.border};text-align:center;">
          <p style="font-family:${F};font-size:17px;font-weight:700;color:${C.text};margin:0 0 4px 0;">Priorité</p>
          <p style="font-family:${F};font-size:11px;color:${C.textDim};margin:0;line-height:1.5;">Traitement<br>accéléré</p>
        </td>
        <td style="padding:20px 16px;vertical-align:top;width:34%;text-align:center;">
          <p style="font-family:${F};font-size:17px;font-weight:700;color:${C.text};margin:0 0 4px 0;">Afrique</p>
          <p style="font-family:${F};font-size:11px;color:${C.textDim};margin:0;line-height:1.5;">Transferts<br>internationaux</p>
        </td>
      </tr>
    </table>
  </div>`;
