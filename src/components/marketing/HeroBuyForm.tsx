...
export function HeroBuyForm() {
  ...
  return (
    <div className="w-[340px] sm:w-[360px] lg:w-[420px] max-w-[92vw]">
      <div className="relative bg-gradient-to-b from-[hsl(0,0%,14%)] to-[hsl(0,0%,11%)] border border-[hsl(0,0%,22%)]/30 rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.4)] overflow-hidden">
        ...
        <div className="px-5 lg:px-6 pb-5 lg:pb-6">
          ...
          {step === 1 && (
            <div className="space-y-3 animate-fade-in">
              {/* Pay input */}
              <div className="relative rounded-2xl p-4 lg:p-5 border border-[hsl(0,0%,20%)]/25 bg-[hsl(0,0%,17%)]/60 hover:border-[hsl(0,0%,25%)]/40 transition-colors">
              ...
              {/* Receive output */}
              <div className="relative rounded-2xl p-4 lg:p-5 border border-terex-accent/15 bg-[hsl(0,0%,17%)]/40">
