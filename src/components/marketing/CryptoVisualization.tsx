      ...
      <div className="crypto-visualization-container relative">
        ...
        <div className="floating-hexagons">
          ...
          <div className="hexagon hex-2">
            <div className="hexagon-content">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M8 14S9.5 16 12 16S16 14 16 14" stroke="#ffffff" strokeWidth="2" strokeLinecap="round"/>
                <path d="M9 9H9.01" stroke="#ffffff" strokeWidth="2" strokeLinecap="round"/>
                <path d="M15 9H15.01" stroke="#ffffff" strokeWidth="2" strokeLinecap="round"/>
              </svg>
            </div>
          </div>
          ...
          <div className="hexagon hex-5">
            <div className="hexagon-content">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 2V6M6.41 6.41L9.18 9.18M2 12H6M6.41 17.59L9.18 14.82M12 18V22M17.59 17.59L14.82 14.82M22 12H18M17.59 6.41L14.82 9.18" stroke="#ffffff" strokeWidth="2" strokeLinecap="round"/>
              </svg>
            </div>
          </div>
          ...
          <div className="hexagon hex-6">
            <div className="hexagon-content">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="3" y="4" width="7" height="7" rx="1" stroke="#ffffff" strokeWidth="2"/>
                <rect x="14" y="4" width="7" height="7" rx="1" stroke="#ffffff" strokeWidth="2"/>
                <rect x="14" y="13" width="7" height="7" rx="1" stroke="#ffffff" strokeWidth="2"/>
                <rect x="3" y="13" width="7" height="7" rx="1" stroke="#ffffff" strokeWidth="2"/>
              </svg>
            </div>
          </div>
        </div>
          ...
          <svg className="connections-svg" width="100%" height="100%" viewBox="0 0 400 400">
            <defs>
              <linearGradient id="lineGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <stop offset="100%" stopColor="#cfcfcf" stopOpacity="0.1"/>
              </linearGradient>
            </defs>
