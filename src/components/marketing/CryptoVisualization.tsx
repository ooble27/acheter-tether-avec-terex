      ...
      <div className="crypto-visualization-container relative">
        ...
        <div className="floating-hexagons">
          ...
          <div className="hexagon hex-5">
            <div className="hexagon-content">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 2V6M6.41 6.41L9.18 9.18M2 12H6M6.41 17.59L9.18 14.82M12 18V22M17.59 17.59L14.82 14.82M22 12H18M17.59 6.41L14.82 9.18" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
              </svg>
            </div>
          </div>
          ...
          <div className="hexagon hex-6">
            <div className="hexagon-content">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="3" y="4" width="7" height="7" rx="1" stroke="currentColor" strokeWidth="2"/>
                <rect x="14" y="4" width="7" height="7" rx="1" stroke="currentColor" strokeWidth="2"/>
