      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold text-white mb-6 md:mb-8 leading-tight">
              L'expérience <span className="text-terex-accent">Terex</span> dans votre poche
            </h2>
            
            {/* Phone Mockup on mobile - between title and subtitle */}
