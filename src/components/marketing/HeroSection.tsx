...
import { LocalStorePayment } from './LocalStorePayment';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Révolutionnez vos paiements avec des transactions USDT instantanées, 
            sécurisées et sans frais dans tous les commerces partenaires.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-12 justify-center">
            {user ? (
              <Button 
        ...
        {/* Realistic Payment Scene */}
        <div className="mb-16">
          <LocalStorePayment />
        </div>
        
        {/* Stats Section */}
        <div className="grid grid-cols-3 gap-4 text-center lg:text-left mb-16 max-w-2xl mx-auto">
          <div>
            <div className="text-2xl font-bold text-terex-accent">5sec</div>
            <div className="text-sm text-gray-400">Paiement rapide</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-terex-accent">0%</div>
            <div className="text-sm text-gray-400">Frais</div>
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <Card className="bg-terex-darker/60 border-terex-accent/30 backdrop-blur-sm hover:bg-terex-darker/80 transition-all duration-300 hover:scale-105 group">
            <CardContent className="p-4 sm:p-6 text-center">
              ...
              <h3 className="text-white font-semibold mb-2 text-sm sm:text-base">Paiements USDT</h3>
              <p className="text-gray-400 text-xs sm:text-sm">Payez instantanément avec vos USDT</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-terex-darker/60 border-terex-accent/30 backdrop-blur-sm hover:bg-terex-darker/80 transition-all duration-300 hover:scale-105 group">
            <CardContent className="p-4 sm:p-6 text-center">
              ...
              <h3 className="text-white font-semibold mb-2 text-sm sm:text-base">Commerces partenaires</h3>
              <p className="text-gray-400 text-xs sm:text-sm">Des milliers de commerces acceptent USDT</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-terex-darker/60 border-terex-accent/30 backdrop-blur-sm hover:bg-terex-darker/80 transition-all duration-300 hover:scale-105 group sm:col-span-2 lg:col-span-1">
            <CardContent className="p-4 sm:p-6 text-center">
              ...
              <p className="text-gray-400 text-xs sm:text-sm">Transactions blockchain sécurisées</p>
            </CardContent>
          </Card>
        </div>
      </div>
