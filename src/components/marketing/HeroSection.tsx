          ...
          <div className="flex flex-col items-center text-center pt-12 pb-8">
            <AnimatedSection className="w-full mb-8" delay={100}>
              <h1 className="text-[2.25rem] leading-[1.12] font-bold text-foreground tracking-[-0.02em] mb-4">
                {t.hero.titleMobile}<br />
                {t.hero.titleMobileLine2}{t.hero.titleMobileLine2 ? ' ' : ''}
              ...
              <div className="relative grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="relative bg-terex-darker/80 backdrop-blur-md rounded-2xl border border-terex-gray/25 p-5 lg:p-6 shadow-xl hover:border-terex-accent/30 transition-all duration-500 hover:-translate-y-1">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-foreground font-medium text-sm lg:text-base">{t.hero.exchangeUsdt}</span>
                  </div>
                  <div className="space-y-2 text-xs lg:text-sm">
                    <div className="flex items-center gap-2 text-muted-foreground"><div className="w-1.5 h-1.5 rounded-full bg-terex-accent" /><span>{t.hero.instantPurchase}</span></div>
                    <div className="flex items-center gap-2 text-muted-foreground"><div className="w-1.5 h-1.5 rounded-full bg-terex-accent" /><span>{t.hero.quickSale}</span></div>
                    <div className="flex items-center gap-2 text-muted-foreground"><div className="w-1.5 h-1.5 rounded-full bg-terex-accent" /><span>{t.hero.bestCfaRate}</span></div>
                  </div>
                  <div className="mt-4 text-[10px] lg:text-xs text-muted-foreground/60">{t.hero.networksSupported}</div>
                </div>
                ...
                <div className="relative bg-terex-darker/80 backdrop-blur-md rounded-2xl border border-terex-accent/25 p-5 lg:p-6 shadow-xl lg:-translate-y-3 hover:border-terex-accent/40 transition-all duration-500 hover:-translate-y-4">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-foreground font-medium text-sm lg:text-base">{t.hero.transfers}</span>
                    <span className="ml-auto text-[9px] lg:text-[10px] px-2 py-0.5 rounded-full border border-terex-accent/30 text-terex-accent">{t.hero.live}</span>
                  </div>
                  <div className="space-y-2 text-xs lg:text-sm">
                    <div className="flex items-center gap-2 text-muted-foreground"><div className="w-1.5 h-1.5 rounded-full bg-terex-accent" /><span>{t.hero.africaCountries}</span></div>
                    <div className="flex items-center gap-2 text-muted-foreground"><div className="w-1.5 h-1.5 rounded-full bg-terex-accent" /><span>{t.hero.mobileMoney}</span></div>
                    <div className="flex items-center gap-2 text-muted-foreground"><div className="w-1.5 h-1.5 rounded-full bg-terex-accent" /><span>{t.hero.lessThan5Min}</span></div>
                  </div>
                  <div className="mt-4 text-[10px] lg:text-xs text-muted-foreground/60">{t.hero.realTimeTracking}</div>
                </div>

                <div className="relative bg-terex-darker/80 backdrop-blur-md rounded-2xl border border-terex-gray/25 p-5 lg:p-6 shadow-xl hover:border-terex-accent/30 transition-all duration-500 hover:-translate-y-1">
                  <div className="flex items-center gap-3 mb-4">
                    <Shield className="w-6 h-6 lg:w-7 lg:h-7 text-terex-accent" />
                    <span className="text-foreground font-medium text-sm lg:text-base">{t.hero.security}</span>
                  </div>
                  <div className="space-y-2 text-xs lg:text-sm">
                    <div className="flex items-center gap-2 text-muted-foreground"><div className="w-1.5 h-1.5 rounded-full bg-terex-accent" /><span>{t.hero.encryption}</span></div>
                    <div className="flex items-center gap-2 text-muted-foreground"><div className="w-1.5 h-1.5 rounded-full bg-terex-accent" /><span>{t.hero.nonCustodial}</span></div>
                    <div className="flex items-center gap-2 text-muted-foreground"><div className="w-1.5 h-1.5 rounded-full bg-terex-accent" /><span>{t.hero.kycVerified}</span></div>
                  </div>
                  <div className="mt-4 text-[10px] lg:text-xs text-muted-foreground/60">{t.hero.regulatoryCompliance}</div>
                </div>
              </div>
            </div>
          </AnimatedSection>
