              ...
              <div className="space-y-3">
                {currentQuestion.answers.map((answer, index) => (
                  <Button
                    key={index}
                    variant="outline"
                    className="w-full justify-start text-left h-auto py-4 px-6 border-terex-accent/30 text-gray-300 hover:bg-terex-accent/10 hover:text-[hsl(var(--terex-accent-fg))] hover:border-terex-accent/50"
