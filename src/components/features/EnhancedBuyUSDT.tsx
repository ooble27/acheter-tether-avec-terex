...
export function EnhancedBuyUSDT() {
  ...
  const { createOrder } = useEnhancedOrders();
    ...
    <div className="min-h-screen bg-terex-dark p-2 md:p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 md:mb-8">
          ...
          <p className="text-gray-400">Achetez des USDT facilement avec notifications automatiques</p>
        </div>
            ...
            <Card className="bg-terex-darker border-terex-gray">
              <CardHeader className="p-4">
                <CardTitle className="text-white text-base md:text-lg flex items-center">
                  <Mail className="w-4 h-4 md:w-5 md:h-5 mr-2 text-terex-accent" />
                  Notifications
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 p-4 pt-0">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-white text-sm font-medium">Confirmation instantanée</p>
                    <p className="text-gray-400 text-xs">Email envoyé dès la commande</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs">Notifications à chaque étape</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-4 h-4 text-terex-accent mt-1" />
                  <div>
                    <p className="text-white text-sm font-medium">Confirmation de réception</p>
                    <p className="text-gray-400 text-xs">Email quand les USDT sont envoyés</p>
                  </div>
                </div>
              </CardContent>
            </Card>
