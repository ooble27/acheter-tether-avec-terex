...
export function OTC() {
  ...
  return (
    <div className="min-h-screen bg-terex-dark text-white">
      <div className="w-full max-w-7xl mx-auto space-y-4 md:space-y-8 px-2 md:px-6 py-3 md:py-6">
        {/* Header */}
        <div className="flex flex-col space-y-3 md:space-y-0 md:flex-row md:items-center justify-between">
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <div>
              <h1 className="text-xl md:text-3xl font-bold text-white">Trading OTC</h1>
              <p className="text-gray-400 text-xs md:text-base">Négociation de gros volumes avec des conditions préférentielles</p>
            </div>
          </div>
          <Badge variant="outline" className="bg-terex-accent/10 text-terex-accent border-terex-accent/30 self-start md:self-auto text-xs">
            Pro Trading
          </Badge>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-3 md:space-y-6">
          <div className="w-full overflow-x-auto">
            <TabsList className="bg-terex-darker border border-terex-gray/30 flex w-full min-w-max md:w-auto">
              <TabsTrigger 
                value="overview" 
                className="data-[state=active]:bg-terex-accent data-[state=active]:text-white text-xs md:text-sm px-2 md:px-4 flex-1 md:flex-none"
              >
                Vue d'ensemble
              </TabsTrigger>
              <TabsTrigger 
