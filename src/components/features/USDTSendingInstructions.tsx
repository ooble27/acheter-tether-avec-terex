      ...
      <div className="w-full max-w-4xl mx-auto px-2 md:px-0">
        <div className="mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">
            {orderData.useBinancePay ? 'Instructions Binance Pay' : 'Instructions d\'envoi USDT'}
          </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              ...
              <div className="space-y-1">
                ...
                <div className="text-white">
                  {orderData.useBinancePay ? 'Binance Pay' : `Blockchain ${orderData.network}`}
                </div>
              </div>
            </div>
          </CardContent>
                  ...
                  <div>
                    ...
                    <div className="bg-terex-gray rounded-lg p-4 space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-white font-mono text-sm">teranga.exchange@gmail.com</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-400 text-sm">ID Binance</span>
                        <span className="text-white font-mono text-sm">TEREX123456</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-400 text-sm">Pay ID</span>
                        <span className="text-white font-mono text-sm">TEREX_PAY_ID</span>
                      </div>
                    </div>
                  </div>
              ...
              >
                {confirmingSent ? (
                  ...
                  <>
                    ...
                    {orderData.useBinancePay ? 'Transfert effectué' : 'USDT Envoyé'}
                  </>
                )}
              </Button>

              <p className="text-gray-400 text-xs text-center">
                En cliquant sur ce bouton, vous confirmez avoir {orderData.useBinancePay ? 'effectué le transfert via Binance Pay' : 'envoyé les USDT à l\'adresse indiquée'}
              </p>
            </div>
          </CardContent>
        </Card>
