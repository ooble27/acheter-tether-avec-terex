...
export function USDTSendingInstructions({ orderData, onBack, onUSDTSent }: USDTSendingInstructionsProps) {
  ...
  return (
    <div className="min-h-screen bg-terex-dark px-0 md:p-4">
      <div className="w-full max-w-5xl md:max-w-4xl mx-auto px-1 md:px-2">
        ...
        <Card className="bg-terex-darker border-terex-gray mb-6 w-full mx-0 md:mx-0">
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    size="lg"
                    className="w-full bg-terex-accent hover:bg-terex-accent/80 text-[hsl(var(--terex-accent-fg))] font-semibold h-12 text-lg"
                  >
                    {!imageError ? (
                      <img 
