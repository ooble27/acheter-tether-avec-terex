            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3 text-left">
                  <div className="w-6 h-6 bg-terex-accent rounded-full flex items-center justify-center text-[hsl(var(--terex-accent-fg))] text-sm font-bold mt-0.5 flex-shrink-0">
                    1
                  </div>
