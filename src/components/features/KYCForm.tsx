    ...
    <form onSubmit={handleSubmit} className="w-full max-w-none mx-auto space-y-6 md:space-y-8">
      ...
      <div className="flex justify-center pt-6 md:pt-8">
        <Button 
          type="submit"
          disabled={submitting}
          className="bg-terex-accent hover:bg-terex-accent/90 text-[hsl(var(--terex-accent-fg))] font-medium px-12 md:px-16 py-4 md:py-5 text-lg md:text-xl h-auto rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 w-full md:w-auto max-w-md"
        >
          {submitting ? (
            <>
