        ...
        <div className="flex items-center justify-between">
          ...
          {!isEditing && (
            <Button
              ...
              variant="outline"
              size="sm"
              className="border-terex-accent/50 text-terex-accent hover:bg-terex-accent hover:text-[hsl(var(--terex-accent-fg))] transition-all duration-200 text-xs md:text-sm px-2 md:px-3 py-1 md:py-2 h-7 md:h-9"
            >
