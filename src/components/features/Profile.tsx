...
export function Profile({ user, onLogout }: ProfileProps) {
  ...
  return (
    <div className="min-h-screen bg-terex-dark p-4 md:p-6 lg:p-8 animate-fade-in">
      ...
      <div className="bg-gradient-to-br from-terex-darker/95 to-terex-dark/95 border border-white/10 rounded-2xl mb-6 md:mb-8 p-6 md:p-8 shadow-2xl backdrop-blur-sm">
