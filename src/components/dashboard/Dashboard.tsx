            ...
            <div className="fixed top-6 right-6 z-50 flex items-center gap-3">
              ...
              {isTablet && (
                <Button 
                  ...
                  className="h-10 px-6 bg-red-600/20 hover:bg-red-600 border border-red-600/30 text-red-400 hover:text-white transition-all duration-200 rounded-xl font-medium text-sm shadow-lg"
                >
