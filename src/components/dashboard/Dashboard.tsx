...
import { ModernOrdersAdmin } from '@/components/admin/ModernOrdersAdmin';
...
export function Dashboard({ user, onLogout }: DashboardProps) {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case 'orders-admin':
        return isKYCReviewer() ? <ModernOrdersAdmin /> : <div className="text-white">Accès non autorisé</div>;
      default:
        return <DashboardHome user={user} />;
    }
  };
