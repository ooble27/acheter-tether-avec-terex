...
export function DashboardHome({ user, onNavigate }: DashboardHomeProps) {
  ...
  if (isMobile) {
    // Design mobile avec marges optimisées
    return (
      <div className="min-h-screen bg-terex-dark px-0 space-y-3 text-xs overflow-y-auto scrollbar-hide">
        {/* Header avec taille augmentée comme demandé */}
        <div className="flex items-center space-x-3 mb-6 px-3 pt-3">
        ...
        <Card className="bg-terex-darker border-terex-gray mx-3 mb-3">
          <CardContent className="p-3">
            <h3 className="text-white text-sm font-medium mb-3 flex items-center">
