    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button 
          variant="ghost" 
          size="icon" 
          className="fixed top-4 right-4 z-50 bg-card/95 backdrop-blur-sm border border-border text-foreground hover:bg-muted shadow-lg rounded-xl w-12 h-12 mt-safe"
        >
      ...
      <SheetContent 
        side="right" 
        className="w-80 bg-card border-l border-border p-0 shadow-2xl no-scrollbar"
      >
