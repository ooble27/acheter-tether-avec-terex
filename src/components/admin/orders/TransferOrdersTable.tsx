  ...
  if (orders.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        >
          <Send className="w-8 h-8" style={{ color: 'rgba(255,255,255,0.85)' }} />
        </div>
        <h3 className="text-lg font-medium mb-2" style={{ color: '#fff' }}>Aucun transfert international</h3>
        <p style={{ color: '#9ca3af' }}>Il n'y a aucun transfert à afficher.</p>
      </div>
    );
  }
            ...
            >
              <div className="p-3.5 sm:p-4 flex flex-col lg:flex-row lg:items-center gap-3 lg:gap-4">
                ...
                <div className="flex items-center gap-3 min-w-0 lg:flex-1">
                  ...
                  >
                    <Send className="w-5 h-5" style={{ color: 'rgba(255,255,255,0.85)' }} />
                  </div>
                ...
                <div className="lg:text-right lg:px-2 shrink-0">
                  ...
                  <div className="text-xs" style={{ color: '#9ca3af' }}>
                    → {order.total_amount} {order.to_currency}
                  </div>
                </div>
