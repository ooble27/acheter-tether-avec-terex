      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex gap-10 py-12 md:py-16">
        ...
        <main className="flex-1 min-w-0 max-w-3xl space-y-14">
          ...
          <section id="preambule">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">1. Préambule et Identification</h2>
          ...
          <section id="definitions">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">2. Définitions</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
          ...
          <section id="champ-application">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">3. Champ d'Application et Acceptation</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
          ...
          <section id="description-services">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">4. Description des Services Terex</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
          ...
          <section id="eligibilite">
            ...
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              ...
              <p>L'accès aux Services est interdit aux personnes résidant dans des pays faisant l'objet de sanctions internationales, notamment ceux figurant sur les listes de l'Office of Foreign Assets Control (OFAC) des États-Unis, du Conseil de l'Union Européenne, des Nations Unies, ou de tout autre organisme de sanctions pertinent.</p>
              <p>En accédant aux Services, l'Utilisateur déclare et garantit : (i) avoir l'âge légal requis et la capacité juridique nécessaire ; (ii) ne pas être sous tutelle ou curatelle ; (iii) agir en son nom propre et pour son compte personnel ; (iv) ne pas avoir fait l'objet d'une décision de suspension ou d'exclusion de la part de Terex par le passé.</p>
            </div>
          </section>

          <section id="gestion-compte">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">6. Création et Gestion du Compte</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              ...
              <p>Chaque Utilisateur ne peut détenir qu'un seul et unique Compte sur la Plateforme. La création de comptes multiples, que ce soit sous des identités différentes ou en utilisant des informations partiellement modifiées, est strictement prohibée et constitue une violation grave des présentes CGU.</p>
              <p>L'Utilisateur est responsable de la confidentialité de ses identifiants de connexion et de toute activité effectuée depuis son Compte. Il s'engage à choisir un mot de passe robuste d'au moins douze (12) caractères et à le modifier régulièrement. Il est fortement recommandé d'activer l'authentification à deux facteurs (2FA) dès la création du Compte.</p>
              <p>En cas de perte, de vol ou de compromission des identifiants de connexion, l'Utilisateur doit immédiatement en informer Terex via les canaux de support disponibles sur la Plateforme. La responsabilité de Terex ne saurait être engagée pour les dommages résultant d'une utilisation non autorisée du Compte avant la notification de la compromission.</p>
              <p>L'Utilisateur s'engage à maintenir ses informations de profil à jour, notamment son adresse e-mail, son numéro de téléphone et son adresse de résidence. Tout changement significatif devra être communiqué à Terex dans les plus brefs délais.</p>
            </div>
          </section>

          <section id="kyc-aml">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">7. Vérification d'Identité (KYC/AML)</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>Conformément aux obligations légales imposées par la loi uniforme relative à la lutte contre le blanchiment de capitaux et le financement du terrorisme adoptée par les États membres de l'UEMOA, ainsi qu'aux directives de la BCEAO et aux meilleures pratiques internationales du Groupe d'Action Financière (GAFI), Terex est tenu de mettre en place et d'appliquer rigoureusement des procédures de Connaissance Client (KYC) et de vigilance anti-blanchiment (AML).</p>
              <p>La vérification d'identité est obligatoire pour accéder à l'ensemble des fonctionnalités de la Plateforme. Elle comprend obligatoirement : la fourniture d'une pièce d'identité officielle en cours de validité (carte nationale d'identité, passeport biométrique ou titre de séjour), un justificatif de domicile de moins de trois (3) mois, et une photo de l'Utilisateur tenant sa pièce d'identité (procédure dite « selfie avec document »).</p>
              <p>Les niveaux de vérification sont progressifs. Le niveau 1 (identité de base) permet d'effectuer des transactions jusqu'à 500 000 FCFA par mois. Le niveau 2 (vérification complète avec justificatif de domicile) permet des transactions jusqu'à 5 000 000 FCFA par mois. Des niveaux supplémentaires peuvent être requis pour les volumes plus importants.</p>
              <p>Terex se réserve le droit de demander des documents complémentaires à tout moment, notamment en cas de transaction atypique ou de doute quant à l'identité de l'Utilisateur. En cas de refus de l'Utilisateur de se conformer à ces demandes, Terex est en droit de suspendre le Compte et de bloquer les transactions en cours.</p>
              <p>Terex applique des procédures de surveillance continue des transactions afin de détecter toute activité suspecte. En cas de détection d'une telle activité, Terex est tenu de procéder à une déclaration de soupçon auprès de la CENTIF (Cellule Nationale de Traitement des Informations Financières du Sénégal), conformément à ses obligations légales.</p>
            </div>
          </section>

          <section id="utilisation">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">8. Utilisation des Services</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>L'Utilisateur s'engage à utiliser les Services Terex de manière loyale, légale et conforme aux présentes CGU. L'utilisation des Services est strictement personnelle et ne peut faire l'objet d'une cession, d'une sous-licence ou d'un transfert à titre onéreux ou gratuit à un tiers, sauf autorisation expresse et préalable de Terex.</p>
              <p>Terex met à disposition de l'Utilisateur un tableau de bord permettant de visualiser son solde, l'historique de ses transactions, le statut de ses vérifications KYC et les taux de change en vigueur. Ces informations sont fournies à titre indicatif et peuvent être sujettes à des délais de mise à jour.</p>
              <p>L'Utilisateur reconnaît que les taux de change des cryptomonnaies sont volatils et peuvent évoluer significativement dans un délai très court. Terex applique un taux de change indicatif au moment de l'initiation de la transaction, qui peut légèrement différer du taux définitif au moment de l'exécution, en raison des fluctuations du marché.</p>
              <p>L'accès aux Services peut être restreint ou interrompu temporairement en cas de maintenance programmée, de mise à jour des systèmes, de problèmes techniques imprévus ou de force majeure. Terex décline toute responsabilité pour les pertes ou préjudices résultant d'une interruption de service indépendante de sa volonté.</p>
            </div>
          </section>

          <section id="transactions">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">9. Commandes et Transactions</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>Toute transaction initiée sur la Plateforme Terex suit un processus en plusieurs étapes. L'Utilisateur sélectionne le type d'opération souhaité (achat ou vente de cryptomonnaies), le montant et le moyen de paiement. Un récapitulatif détaillé de la transaction — incluant le taux de change applicable, les frais de service et le montant net — est présenté à l'Utilisateur avant confirmation.</p>
              <p>Une fois confirmée, la transaction est engageante et ne peut être annulée que dans les conditions strictement définies à l'article 11 (Politique de Remboursement). L'Utilisateur reconnaît que les transactions en cryptomonnaies, une fois diffusées sur la blockchain, sont irréversibles par nature. Terex ne peut en aucun cas annuler ou inverser une transaction blockchain confirmée.</p>
              <p>Les délais de traitement des transactions varient selon le moyen de paiement utilisé et les conditions du réseau blockchain. Pour les achats via Mobile Money, le délai habituel est de cinq (5) à trente (30) minutes. Pour les ventes avec reversement via Mobile Money, le délai habituel est de cinq (5) à soixante (60) minutes.</p>
              ...
              <p>Les limites de transaction applicables à chaque niveau de compte sont affichées dans l'espace utilisateur. L'Utilisateur s'engage à respecter ces limites et reconnaît que toute tentative de contournement (notamment par la fragmentation artificielle des transactions) constitue une violation grave des CGU et des lois anti-blanchiment.</p>
            </div>
          </section>

          <section id="tarifs">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">10. Tarifs, Frais et Commissions</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              ...
              <p>Les frais standard applicables aux opérations courantes sont les suivants : pour l'achat d'USDT, une commission de service de 1% à 2% du montant total est appliquée selon le moyen de paiement utilisé. Pour la vente d'USDT avec reversement en Mobile Money, une commission de 1% à 1,5% est appliquée.</p>
              <p>Des frais de réseau blockchain (« gas fees ») s'ajoutent aux frais de service Terex pour les transactions impliquant un transfert sur la blockchain. Ces frais sont déterminés par les conditions du réseau (Tron, Ethereum, Binance Smart Chain) au moment de la transaction et ne sont pas contrôlés par Terex.</p>
              <p>Terex se réserve le droit de modifier sa grille tarifaire à tout moment. Toute modification des tarifs sera communiquée aux Utilisateurs par e-mail et par notification sur la Plateforme au moins trente (30) jours avant son entrée en vigueur. L'utilisation des Services après cette période vaut acceptation des nouveaux tarifs.</p>
            </div>
          </section>

          <section id="remboursement">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">11. Politique de Remboursement</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>En raison de la nature irréversible des transactions en cryptomonnaies et des contraintes techniques inhérentes aux réseaux blockchain, la politique de remboursement de Terex est strictement encadrée. En règle générale, toute transaction confirmée et exécutée est définitive et ne peut faire l'objet d'un remboursement.</p>
              <p>Des remboursements peuvent être accordés dans les cas limitatifs suivants : (i) erreur technique avérée de la part de Terex ayant conduit à une exécution incorrecte de la transaction ; (ii) double débit constaté sur le compte de paiement de l'Utilisateur suite à un dysfonctionnement technique ; (iii) transaction annulée par l'Utilisateur avant son exécution effective, dans un délai de quinze (15) minutes suivant la confirmation.</p>
              <p>Pour demander un remboursement, l'Utilisateur doit contacter le service support de Terex dans un délai maximum de quarante-huit (48) heures suivant la date de la transaction litigieuse, en fournissant l'identifiant de la transaction, le montant concerné et une description précise du problème.</p>
              <p>Terex s'engage à traiter les demandes de remboursement éligibles dans un délai de cinq (5) à dix (10) jours ouvrables suivant la réception et validation de la demande. Le remboursement s'effectue vers le même moyen de paiement utilisé lors de la transaction initiale.</p>
            </div>
          </section>

          <section id="securite-compte">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">12. Sécurité du Compte et Authentification</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>La sécurité des comptes Utilisateurs est une priorité absolue pour Terex. La Société déploie des mesures de sécurité techniques et organisationnelles de niveau professionnel, incluant le chiffrement des données en transit (TLS 1.3) et au repos (AES-256), la surveillance continue des systèmes, et des audits de sécurité réguliers réalisés par des prestataires indépendants.</p>
              <p>L'authentification à deux facteurs (2FA) est fortement recommandée et peut être rendue obligatoire pour certaines opérations sensibles (modifications des paramètres de compte, retraits importants). Le 2FA peut être mis en place via une application d'authentification (Google Authenticator, Authy) ou par SMS.</p>
              <p>L'Utilisateur est responsable de la sécurité de ses appareils et de son environnement informatique. Il s'engage à ne pas accéder aux Services depuis des réseaux Wi-Fi publics non sécurisés, à maintenir ses appareils à jour avec les derniers correctifs de sécurité, et à ne jamais partager ses identifiants avec quiconque.</p>
          ...
          <section id="propriete-intellectuelle">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">13. Propriété Intellectuelle</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              ...
              <p>Terex accorde à l'Utilisateur une licence non exclusive, non transférable, limitée et révocable d'accès et d'utilisation de la Plateforme aux fins strictement personnelles et non commerciales décrites dans les présentes CGU. Cette licence ne constitue en aucun cas un transfert de propriété.</p>
              <p>Il est strictement interdit de reproduire, copier, modifier, créer des œuvres dérivées, distribuer, vendre, concéder sous licence, décompiler, désassembler ou tenter d'extraire le code source de la Plateforme Terex, en tout ou en partie, sans l'autorisation écrite préalable de Terex.</p>
          ...
          <section id="donnees-personnelles">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">14. Protection des Données Personnelles</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              ...
              <p>Terex collecte et traite les données personnelles des Utilisateurs dans le cadre de l'exécution du contrat de services, du respect de ses obligations légales (notamment en matière de KYC/AML), de ses intérêts légitimes (prévention de la fraude, amélioration des services, sécurité informatique) et, le cas échéant, du consentement de l'Utilisateur pour les traitements optionnels.</p>
              <p>En accord avec la loi sénégalaise n° 2008-12 du 25 janvier 2008 sur la protection des données à caractère personnel et les principes du Règlement Général sur la Protection des Données (RGPD) de l'Union Européenne, les Utilisateurs bénéficient de droits d'accès, de rectification, d'effacement, de portabilité et d'opposition relatifs à leurs données personnelles.</p>
              <p>Terex s'engage à ne jamais vendre les données personnelles de ses Utilisateurs à des tiers à des fins commerciales. Le partage de données avec des tiers est strictement limité aux cas nécessaires à l'exécution des services et aux cas d'obligation légale.</p>
            </div>
          </section>

          <section id="confidentialite">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">15. Confidentialité et Secret Professionnel</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>Terex est soumis à une obligation de confidentialité professionnelle concernant toutes les informations relatives aux transactions et à la situation financière de ses Utilisateurs. Cette obligation s'étend à l'ensemble du personnel de Terex et à ses sous-traitants, qui sont liés par des clauses de confidentialité contractuelles strictes.</p>
              ...
              <p>De même, l'Utilisateur s'engage à maintenir la confidentialité des informations techniques dont il pourrait prendre connaissance dans le cadre de l'utilisation des Services. Il s'engage également à ne pas divulguer publiquement des informations susceptibles de nuire à la réputation ou aux intérêts légitimes de Terex.</p>
            </div>
          </section>

          <section id="risques">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">16. Risques liés aux Cryptomonnaies</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>L'Utilisateur reconnaît expressément que les cryptomonnaies, y compris les stablecoins tels que l'USDT, comportent des risques spécifiques et inhérents à leur nature. Ces risques incluent, sans s'y limiter : la volatilité des prix, le risque technologique lié aux failles potentielles des protocoles blockchain, le risque de contrepartie lié à la solvabilité des émetteurs de stablecoins, et le risque réglementaire lié à l'évolution des cadres juridiques nationaux et internationaux.</p>
              <p>Les stablecoins comme l'USDT sont conçus pour maintenir une parité avec le dollar américain, mais cette stabilité n'est pas garantie absolument. Des événements exceptionnels peuvent entraîner une dépréciation temporaire ou permanente de la valeur d'un stablecoin. L'Utilisateur accepte ce risque résiduel en utilisant les Services Terex.</p>
              ...
              <p>Terex ne fournit aucun conseil en investissement, fiscal ou juridique. Les informations disponibles sur la Plateforme sont fournies à titre purement informatif et ne constituent pas des recommandations d'investissement. L'Utilisateur prend ses décisions d'investissement sous sa seule et entière responsabilité.</p>
            </div>
          </section>

          <section id="comportements-prohibes">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">17. Comportements Prohibés</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>L'utilisation des Services Terex est strictement interdite pour les activités suivantes : le blanchiment de capitaux sous toutes ses formes, le financement du terrorisme ou d'organisations terroristes, le financement de la prolifération d'armes de destruction massive, et toute autre activité liée à des groupes criminels organisés ou des entités sous sanctions internationales.</p>
              <p>Il est également prohibé d'utiliser les Services pour : la fraude fiscale et toute tentative d'évasion fiscale illégale ; les activités liées au trafic de stupéfiants, d'armes, d'êtres humains ou d'espèces protégées ; le piratage informatique, la cybercriminalité et toute activité portant atteinte à des systèmes informatiques tiers ; et plus généralement, toute activité contraire à l'ordre public et aux bonnes mœurs.</p>
              <p>Sur le plan technique, sont prohibés : toute tentative de contournement des mesures de sécurité de la Plateforme ; l'utilisation de bots, scripts automatisés ou robots d'exploration non autorisés ; les attaques de type déni de service (DDoS) ; et l'utilisation d'informations privilégiées ou confidentielles pour réaliser des transactions.</p>
              <p>La création de comptes multiples pour contourner les limites de transaction, l'utilisation de l'identité d'un tiers ou de faux documents, et le partage de son Compte avec des tiers sont également strictement prohibés. Terex se réserve le droit de détecter ces comportements et de prendre les mesures appropriées, incluant la suspension immédiate du Compte.</p>
            </div>
          </section>

          <section id="suspension-resiliation">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">18. Suspension et Résiliation</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>Terex se réserve le droit de suspendre temporairement ou de résilier définitivement le Compte d'un Utilisateur dans les cas suivants : violation des présentes CGU ; fournissement d'informations fausses lors de l'inscription ou du processus KYC ; activité suspecte au regard des règles LCB-FT ; non-respect des demandes de documents complémentaires ; décision judiciaire ou administrative requérant la suspension ou la clôture du Compte.</p>
              <p>En cas de suspension pour suspicion d'activité frauduleuse ou illégale, Terex n'est pas tenu d'informer préalablement l'Utilisateur. Dans tous les autres cas, Terex s'efforce de notifier l'Utilisateur par e-mail avant de procéder à la suspension, en indiquant les motifs et la durée prévisible.</p>
              <p>En cas de résiliation définitive du Compte pour violation grave des CGU, les fonds présents sur le Compte peuvent être conservés dans l'attente des décisions judiciaires ou administratives compétentes. Terex ne procède pas à la restitution de fonds dont l'origine illicite est avérée ou fortement suspectée.</p>
              <p>L'Utilisateur peut clôturer son Compte à tout moment, sans frais, en adressant une demande écrite au service support de Terex. La clôture du Compte entraîne la cessation immédiate de l'accès aux Services. Les obligations légales de conservation des données restent applicables postérieurement à la clôture du Compte.</p>
            </div>
          </section>

          <section id="limitation-responsabilite">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">19. Limitation de Responsabilité</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>Dans toute la mesure permise par le droit applicable, Terex exclut toute responsabilité pour les dommages indirects, consécutifs, accessoires, spéciaux ou exemplaires, incluant notamment la perte de profits, la perte de revenus, la perte de données, les dommages à la réputation, ou toute autre perte immatérielle.</p>
              <p>La responsabilité totale de Terex, toutes causes confondues, est limitée au montant des frais de service effectivement payés par l'Utilisateur au titre de la transaction à l'origine du dommage, ou, en l'absence d'une telle transaction identifiable, à un montant maximum de cinquante mille (50 000) FCFA.</p>
              <p>Terex n'est pas responsable des interruptions de service dues à des facteurs indépendants de sa volonté, notamment les pannes des réseaux de télécommunications, les coupures d'électricité, les congestions des réseaux blockchain, les défaillances des opérateurs de paiement tiers, ou les attaques informatiques de grande ampleur.</p>
              <p>Terex n'est pas responsable des pertes résultant de l'utilisation non autorisée du Compte de l'Utilisateur due à une négligence de celui-ci dans la protection de ses identifiants, ni des pertes résultant de décisions d'investissement prises par l'Utilisateur sur la base des informations disponibles sur la Plateforme.</p>
            </div>
          </section>

          <section id="indemnisation">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">20. Indemnisation</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>L'Utilisateur s'engage à indemniser, défendre et tenir Terex, ses dirigeants, employés, partenaires et agents indemnes de toute réclamation, poursuite, dommage, perte, responsabilité, coût et dépense (y compris les honoraires d'avocat raisonnables) résultant de : (i) la violation par l'Utilisateur des présentes CGU ou de toute loi applicable ; (ii) l'utilisation des Services en violation des présentes CGU ; (iii) la fourniture d'informations fausses ou inexactes.</p>
              <p>Cette obligation d'indemnisation couvre notamment les dommages causés à des tiers en relation avec l'utilisation des Services par l'Utilisateur, les frais de procédure judiciaire ou administrative engagés par Terex en raison du comportement de l'Utilisateur, et les amendes ou pénalités infligées à Terex en raison d'une violation imputable à l'Utilisateur.</p>
              <p>Terex se réserve le droit d'assurer à ses propres frais la défense et le contrôle exclusif de toute affaire susceptible de donner lieu à une obligation d'indemnisation de la part de l'Utilisateur, auquel cas l'Utilisateur coopère pleinement avec Terex pour faire valoir tous les moyens de défense disponibles.</p>
            </div>
          </section>

          <section id="force-majeure">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">21. Force Majeure</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>Terex n'est pas responsable de tout retard ou manquement dans l'exécution de ses obligations résultant d'un événement de force majeure, c'est-à-dire tout événement extérieur, imprévisible et irrésistible au sens du droit sénégalais applicable. Constituent notamment des cas de force majeure : les catastrophes naturelles, les pandémies, les actes de guerre ou de terrorisme, les émeutes et troubles civils, les décisions gouvernementales, les pannes massives des infrastructures Internet, et les attaques informatiques de grande ampleur.</p>
              <p>En cas d'événement de force majeure, Terex en informe l'Utilisateur dès que possible et s'efforce de reprendre l'exécution normale des Services dans les meilleurs délais. Si l'événement de force majeure se prolonge au-delà de trente (30) jours consécutifs, chacune des parties peut résilier le contrat de services par notification écrite, sans indemnité de part et d'autre.</p>
              <p>Les perturbations des réseaux blockchain (congestion, hard fork, attaques sur le consensus) constituent des aléas inhérents à la nature des cryptomonnaies que l'Utilisateur accepte expressément en utilisant les Services Terex.</p>
            </div>
          </section>

          <section id="modifications">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">22. Modifications des Conditions</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>Terex se réserve le droit de modifier les présentes CGU à tout moment, afin de les adapter à l'évolution de ses Services, aux changements réglementaires applicables, ou à toute autre nécessité opérationnelle ou juridique. Toute modification substantielle des CGU est portée à la connaissance des Utilisateurs par notification par e-mail et par affichage d'un avis bien visible sur la Plateforme.</p>
              <p>Le délai de préavis applicable aux modifications substantielles est de trente (30) jours à compter de la date de notification. Les modifications mineures (corrections orthographiques, clarifications rédactionnelles n'affectant pas les droits et obligations des parties) peuvent entrer en vigueur sans délai. La version en vigueur des CGU est toujours accessible sur la Plateforme.</p>
          ...
          <section id="divisibilite">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">23. Divisibilité</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>Si l'une quelconque des dispositions des présentes CGU est déclarée nulle, invalide ou inapplicable par une juridiction compétente, cette disposition sera réputée non écrite, et les autres dispositions resteront en vigueur et conserveront leur plein effet entre les parties.</p>
              <p>Le fait pour Terex de ne pas exercer ou de tarder à exercer un droit ou un recours prévu par les présentes CGU ne constitue pas une renonciation à ce droit ou recours. Les droits et recours prévus dans les présentes CGU sont cumulatifs et non exclusifs de tout autre droit ou recours prévu par la loi.</p>
            </div>
          </section>

          <section id="droit-applicable">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">24. Droit Applicable et Juridiction Compétente</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>Les présentes CGU sont régies, interprétées et appliquées conformément au droit sénégalais, sans égard aux règles de conflit de lois qui pourraient conduire à l'application d'une autre législation. Les dispositions du Code des Obligations Civiles et Commerciales (COCC) du Sénégal, ainsi que les actes uniformes de l'OHADA applicables, constituent la loi de référence pour l'interprétation des présentes CGU.</p>
              <p>En cas de litige relatif à l'interprétation, l'exécution ou la résiliation des présentes CGU, les parties s'engagent à rechercher une solution amiable avant tout recours judiciaire. L'Utilisateur adresse une réclamation écrite à Terex par e-mail à terangaexchange@gmail.com. Terex dispose d'un délai de trente (30) jours à compter de la réception de la réclamation pour y répondre et proposer une solution amiable.</p>
              <p>À défaut de règlement amiable dans le délai susmentionné, tout litige découlant des présentes CGU sera soumis à la compétence exclusive des tribunaux de Dakar, République du Sénégal. Les parties renoncent expressément à toute autre attribution de compétence.</p>
              <p>Les parties peuvent convenir, d'un commun accord, de soumettre leur différend à un arbitrage selon les règles de l'arbitrage OHADA ou de tout autre centre d'arbitrage reconnu, dans la mesure où cela est permis par le droit applicable.</p>
            </div>
          </section>

          <section id="contact">
            <h2 className="text-xl md:text-2xl font-normal text-foreground mb-5 pb-3 border-b border-white/[0.07]">25. Contact et Réclamations</h2>
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
